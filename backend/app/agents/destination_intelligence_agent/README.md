...
该 Agent 在主项目中支撑深度规划模式。完整展示素材位于 [`../../../../assets/showcase/`](../../../../assets/showcase/README.md)，其中深度规划相关内容包括：

| 深度规划研究过程 |
| :---: |
| <img src="../../../../assets/showcase/03%20深度规划研究过程.png" alt="深度规划研究过程" width="520"> |

- 报告样例：[`厦门、汕头 15天14晚旅行攻略`](../../../../assets/showcase/深度规划结果-厦门、汕头%202026-07-01%20至%202026-07-15（15天14晚）旅行攻略.md)
- 历史入口截图：[`04 历史行程界面.png`](../../../../assets/showcase/04%20历史行程界面.png)
